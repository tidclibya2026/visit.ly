...
export type Destination = {
  ...
  heritage?: {
    ...
    source: string;
    landmarks: { title: string; note: string; coordinates: string }[];
...
export const destinations: Destination[] = [
  {
    ...
    heritage: {
      title: "مدينة طبقاتها تمشي مع الزائر",
      narrative: "تقرأ طرابلس القديمة من محلة باب البحر إلى السرايا الحمراء باعتبارها نسيجًا حضريًا تراكمت فيه آثار العهد الكلاسيكي والعمارة الإسلامية والعثمانية، ثم إضافات الحي الإيطالي في بدايات القرن العشرين.",
      evidence: ["قوس ماركوس أوريليوس المؤرخ في 163م ونقوشه الكلاسيكية", "جامع قرجي وجامع الباشا بوصفهما علامتين للعمارة العثمانية", "حمام درغوث وحمام الحلقة والأسواق التقليدية: سوق النساء والحلقة والصاغة والقزدارة"],
      culturalContext: "لا تُقرأ المدينة من مبنى منفرد؛ فالأسواق والحِرف والنحاسيات والحمامات والفسحات تشكل معًا ذاكرة الحياة اليومية. يفتح المتحف الوطني والسرايا الحمراء سياقًا أوسع للحضارات المتعاقبة على ليبيا.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف طرابلس القديمة",
      landmarks: [
        { title: "ميدان الجزائر", note: "نقطة قراءة للنسيج الحضري والواجهة المحيطة.", coordinates: "32.887°N · 13.180°E" },
        { title: "الأزقة والأقواس الداخلية", note: "مسار ميداني داخل المدينة القديمة.", coordinates: "32.892°N · 13.181°E" },
        { title: "قوس ماركوس أوريليوس", note: "معلم كلاسيكي قريب من السرايا الحمراء.", coordinates: "32.894°N · 13.180°E" },
      ],
      timeline: [
        { period: "163م", title: "القوس الكلاسيكي", detail: "يؤرخ ملف المركز قوس ماركوس أوريليوس بهذا العام، مع نقوشه الكلاسيكية." },
        { period: "العهد العثماني", title: "عمارة دينية ومدنية", detail: "تظهر المساجد والحمامات والأسواق طبقة عثمانية حاضرة في نسيج المدينة." },
        { period: "بدايات القرن العشرين", title: "الحي الإيطالي", detail: "تضيف الفسحات والعمارة الإيطالية طبقة جديدة إلى قراءة المدينة." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "مدينة ساحلية بين الذاكرة والطبيعة",
      narrative: "تتصل بنغازي بتاريخ هوسبيردس القديم وبشبكة من المعالم الحضرية والساحلية التي تجعلها محطة قراءة للشرق الليبي قبل الانطلاق إلى الجبل الأخضر ومواقعه الأثرية.",
      evidence: ["شواهد هوسبيردس ومقبرة سيدي اخريبيش والمنارة البحرية", "الجامع العتيق في القرن الثامن عشر وميدان سوق الحوت", "القشلة والكاتدرائية المطلة على بحيرة بنغازي"],
      culturalContext: "يجمع مسار المدينة بين الواجهة البحرية والأسواق والذاكرة المعمارية، كما يفتح على بحيرة بنغازي والمنتزهات والبحيرات الشرقية والمواقع الطبيعية القريبة. تختلف الخدمات والترتيبات الميدانية؛ لذا يُستحسن تأكيدها محليًا قبل الزيارة.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف بنغازي",
      landmarks: [
        { title: "الواجهة البحرية", note: "نقطة انطلاق لقراءة اتصال المدينة بالمتوسط.", coordinates: "32.116°N · 20.067°E" },
        { title: "قلب المدينة", note: "مرجع مكاني للذاكرة الحضرية والمعالم القريبة.", coordinates: "32.113°N · 20.070°E" },
        { title: "شرق الواجهة", note: "امتداد ساحلي نحو أفق المدينة.", coordinates: "32.118°N · 20.080°E" },
      ],
      timeline: [
        { period: "القرن السادس ق.م", title: "هوسبيردس", detail: "يورد ملف المركز أن المدينة عُرفت بهوسبيردس ضمن إقليم المدن الخمس." },
        { period: "القرن الثامن عشر", title: "الجامع العتيق", detail: "معلم إسلامي على الطراز العثماني ضمن ذاكرة المدينة." },
        { period: "1930م", title: "المنارة البحرية", detail: "يربط الملف المنارة بشواهد سيدي اخريبيش والواجهة البحرية." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "حكمة الواحة في الطين والظل",
      narrative: "تظهر غدامس نموذجًا لمدينة صحراوية صاغت عمارتها من الطوب والطين والخشب لتوازن بين الحرارة والتهوية والخصوصية. تتصل الأزقة المظللة بالبيوت والأسواق ومزارع الواحة في نسيج واحد.",
      evidence: ["نحو 161 معلمًا بين مساجد ومدارس وقنصليات وساحات وأسواق ومنازل تقليدية", "عين الفرس وسواقيها بوصفها موردًا تاريخيًا للماء والواحة", "الأبواب المزخرفة والنوافذ الهندسية والزخارف الداخلية المعروفة محليًا بتشرفت"],
      culturalContext: "تكمل الحِرف التقليدية والأزياء والنحاسيات والخزف قراءة المكان. يقترح ملف المركز مسارًا هادئًا يشمل المتحف والمدينة القديمة وسوق الحرف، مع مراعاة خصوصية المجتمع المحلي وترتيبات الزيارة.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف غدامس",
      landmarks: [
        { title: "الواحة", note: "مدخل بصري لعلاقة المدينة بالنخيل والماء.", coordinates: "30.133°N · 9.501°E" },
        { title: "النسيج السكني", note: "فناء داخلي يوضح منطق الخصوصية والتهوية.", coordinates: "30.132°N · 9.498°E" },
        { title: "الممرات المظللة", note: "شبكة مشاة تكيفت مع مناخ الصحراء.", coordinates: "30.134°N · 9.500°E" },
      ],
      timeline: [
        { period: "أكثر من 4,000 سنة", title: "عين الفرس", detail: "يربط ملف المركز عين الفرس بحياة الواحة وسواقيها منذ آلاف السنين." },
        { period: "عمران الواحة", title: "الطين والظل", detail: "تطورت الممرات والبيوت لتوازن بين المناخ والتهوية والخصوصية." },
        { period: "اليوم", title: "الحرف والذاكرة", detail: "تستمر الأسواق والحرف والأزياء التقليدية بوصفها مدخلًا لقراءة المجتمع المحلي." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "متحف مفتوح لما قبل التدوين",
      narrative: "تادرارت أكاكوس نطاق صحراوي واسع في الجنوب الغربي يجمع الوديان والتكوينات الحجرية والفنون الصخرية التي توثق تحولات الحياة البشرية والبيئة عبر عصور بعيدة.",
      evidence: ["فنون صخرية مدرجة ضمن التراث العالمي منذ 1985 وفق ملف المركز", "وديان ومسارات مثل تانشالت وتنخليقة وأونينج وتيمن طرة", "أقواس طبيعية وقلتات مائية وسط الأودية الضيقة"],
      culturalContext: "التجربة لا تُختزل في لقطة صخرية؛ فهي رحلة منظّمة تتطلب مرشدين محليين وخطة نقل وتخييم مسؤولة. يورد الملف أن الرحلات قد تمتد ثلاث ليالٍ بالسيارات أو سبع ليالٍ بالجمال بحسب المسار والظروف.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف أكاكوس",
      landmarks: [
        { title: "التكوينات الحجرية", note: "نقطة لاستكشاف الوديان والكتل الصخرية.", coordinates: "24.918°N · 10.676°E" },
        { title: "القوس الطبيعي", note: "معلم صخري على مسار أكاكوس.", coordinates: "24.930°N · 10.692°E" },
        { title: "نطاق الكثبان", note: "طبقات الحجر الرملي ضمن المشهد الصحراوي.", coordinates: "24.905°N · 10.655°E" },
      ],
      timeline: [
        { period: "ما قبل التدوين", title: "الفن الصخري", detail: "توثق الرسوم الصخرية مراحل من الصيد واستئناس الحيوانات والزراعة والعربات." },
        { period: "1985م", title: "تراث عالمي", detail: "يربط ملف المركز إدراج فنون أكاكوس الصخرية على قائمة التراث العالمي بهذا العام." },
        { period: "اليوم", title: "زيارة منظمة", detail: "تتطلب قراءة الموقع مرشدين محليين وخطة تنقل وتخييم مسؤولة." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "مدينة متوسطية على حافة الساحل",
      narrative: "لبدة الكبرى مدينة أثرية قرب الخمس يتيح تخطيطها الحضري قراءة تاريخ استيطان وتجـارة متوسطية امتد من القرن السابع قبل الميلاد، ثم ازدهرت ضمن إقليم الأمبوريا قبل أن تترك آثارها الرومانية البارزة.",
      evidence: ["الحمامات الرومانية والساحات والنوافير والأسواق", "المسرح والميادين والمنشآت العامة والمعابد والفلل", "المتحف الأثري ومتحف الفسيفساء المرتبطان بقراءة مقتنيات الموقع"],
      culturalContext: "يجمع الموقع بين العمارة وحركة التجارة والبيئة الساحلية؛ ويمكن أن يمتد مسار الزيارة إلى الهضبة القريبة وقراءة فيلا سيلين ضمن سياق الريف الروماني. راجع ساعات الوصول والخدمات محليًا قبل تثبيت المسار.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف لبدة",
      landmarks: [
        { title: "المنطقة الأثرية", note: "قوس حجري ومعالم من قلب الموقع.", coordinates: "32.639°N · 14.290°E" },
        { title: "الساحة الرومانية", note: "أعمدة وبقايا فضاءات عامة.", coordinates: "32.638°N · 14.291°E" },
        { title: "المسار الساحلي", note: "قراءة لبقايا المدينة قرب البحر.", coordinates: "32.640°N · 14.293°E" },
      ],
      timeline: [
        { period: "القرن السابع ق.م", title: "استيطان وتجارة", detail: "يمتد تاريخ الاستيطان والتجارة المتوسطية في لبدة إلى هذه المرحلة وفق ملف المركز." },
        { period: "العصر الروماني", title: "المدينة العامة", detail: "تظهر الحمامات والساحات والأسواق والمعابد والمنشآت العامة في تخطيط الموقع." },
        { period: "1982م", title: "تراث عالمي", detail: "يضع ملف التراث الثقافي لبدة ضمن مواقع ليبيا الخمسة ذات القيمة العالمية." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "قورينا بين المعبد والجبل",
      narrative: "شحات، أو قورينا، مدينة أثرية كلاسيكية في نطاق الجبل الأخضر تجمع بين طبقات يونانية ورومانية وبيزنطية وطبيعة جبلية مفتوحة. يربط المسار بين الحرم الأثري والمنشآت العامة والمدافن والمناظر نحو البحر والجبل.",
      evidence: ["المعابد، ومنها زيوس وأبوللو، والمسارح والحمامات والأروقة والنوافير", "مدينة الموتى والمدافن المحفورة في الصخر", "متحف شحات وما يضمه من منحوتات وفسيفساء وتوابيت وشواهد قبور"],
      culturalContext: "يوثق ملف المركز كثافة كبيرة من الصروح والمزارات داخل الموقع، ويقترح قراءة المكان على مهل بين الهضبتين والحرم المقدس. يظل احترام مسارات الموقع وتعليمات الحماية جزءًا من تجربة الزيارة المسؤولة.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف قورينا ومدينة شحات الأثرية",
      landmarks: [
        { title: "المنطقة الأثرية", note: "مدخل لأعمدة قورينا ومناظر الجبل الأخضر.", coordinates: "32.826°N · 21.862°E" },
        { title: "الحرم الأثري", note: "منشآت ومعالم ضمن النطاق المقدس.", coordinates: "32.824°N · 21.860°E" },
        { title: "المسار العلوي", note: "مدرجات ومسارات حجرية داخل الموقع.", coordinates: "32.828°N · 21.864°E" },
      ],
      timeline: [
        { period: "القرن السابع ق.م", title: "تأسيس قورينا", detail: "يوثق ملف شحات نشأة المدينة الإغريقية في هذه المرحلة." },
        { period: "العصور الكلاسيكية", title: "معابد ومدينة عامة", detail: "تعاقبت طبقات إغريقية ورومانية وبيزنطية تركت معابد ومسارح وحمامات ومدافن." },
        { period: "1982م", title: "تراث عالمي", detail: "تظهر شحات ضمن مواقع ليبيا المدرجة ذات القيمة العالمية في ملف المركز." },
      ],
    },
    gallery: [
  ...
  },
  {
    ...
    heritage: {
      title: "مسرح المدينة عند البحر",
      narrative: "صبراتة موقع أثري ساحلي يقدّم قراءة متصلة للمدينة الرومانية وفضائها العام والمشهد المتوسطي. يتيح المسار زيارة مدتها التقريبية بين ساعتين وأربع ساعات بحسب الإيقاع وفتح المعالم.",
      evidence: ["المسرح الروماني الكبير", "الحي السكني ريجيو السادس والحمامات والساحة العامة المحاطة بالمباني والمعابد", "المتحفان الروماني والبونيقي ومقتنيات من شواهد القبور والآثار الجنائزية"],
      culturalContext: "تجمع صبراتة بين العمارة والمتحف والساحل؛ كما يورد ملف المركز منطقة جنائزية مقدسة تضم جداريات ومشاهد من الحياة البرية والحضرية. اتبع توجيهات الموقع لحماية المعالم وتأكيد إمكانات الزيارة قبل الوصول.",
      source: "مواد مركز المعلومات والتوثيق السياحي · ملف صبراتة",
      landmarks: [
        { title: "المسرح الأثري", note: "أحد أبرز معالم المدينة الرومانية الساحلية.", coordinates: "32.800°N · 12.486°E" },
        { title: "الواجهة الأثرية", note: "بقايا المدينة عند خط المتوسط.", coordinates: "32.799°N · 12.483°E" },
      ],
      timeline: [
        { period: "العصور القديمة", title: "مدينة المتوسط", detail: "تعكس المدينة تداخل التاريخ الحضري بالمشهد الساحلي في غرب ليبيا." },
        { period: "العصر الروماني", title: "المسرح والفضاء العام", detail: "يورد الملف المسرح والحي السكني والحمامات والساحة العامة ضمن أبرز الشواهد." },
        { period: "اليوم", title: "زيارة ميدانية", detail: "يقترح الملف جولة من ساعتين إلى أربع ساعات مع احترام تعليمات حماية الموقع." },
      ],
    },
    gallery: [
