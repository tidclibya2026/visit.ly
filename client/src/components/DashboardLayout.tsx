...
import { FileText, LayoutDashboard, Languages, LogOut, PanelLeft, Users } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Languages, label: "مراجعة الترجمات", path: "/admin/translations" },
  { icon: Users, label: "المنصة العامة", path: "/discover" },
];
