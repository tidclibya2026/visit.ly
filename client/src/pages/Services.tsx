...
export default function Services() {
  ...
  return (
    <SiteShell>
      ...
      <section className="page-frame visa-intake-cta"><div><p className="eyebrow">طلب تأشيرة أولي</p><h2>ابدأ المعلومات الأساسية لرحلتك.</h2><p>نموذج منظم لاستلام الطلبات الأولية، مع إحالة رسمية معلّقة حتى اعتماد القناة المختصة.</p></div><Link href="/visa-intake" className="button button-ink">ابدأ الطلب الأولي</Link></section>
