...
export default function Experiences() {
  ...
  return (
    <SiteShell>
      <section className="inner-hero experiences-hero"><img className="experience-hero-image" src={assets.acacusRocks} alt="تكوينات أكاكوس الصخرية من صور المركز" fetchPriority="high" /><div className="experience-hero-ink" aria-hidden="true" /><div className="page-frame"><p className="eyebrow light">دليل التجارب · {String(experiences.length).padStart(2, "0")} محطات موثقة</p><h1>اختر تجربة،<br /><i>ثم افتح مكانها.</i></h1><p>كل بطاقة تقود إلى مدينة أو معلم محدد، وتوضح موسمه المناسب قبل إضافته إلى مخطط رحلتك.</p></div></section>
