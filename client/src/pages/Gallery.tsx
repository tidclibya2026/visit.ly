import { Check, ExternalLink, Images, Link2, MapPin, Search, SlidersHorizontal, X } from "lucide-react";
...
const galleryLabels = {
  ar: { eyebrow: "أرشيف المركز", title: "ليبيا، كما تحفظها الصورة.", copy: "معرض ميداني من صور مركز المعلومات والتوثيق السياحي؛ كل لقطة مرتبطة بمكانها ومصدرها ومعلَمها.", all: "كل الصور", filter: "التصفية", city: "المدينة أو الموقع", type: "نوع الوجهة", season: "موسم الزيارة", albums: "ألبومات موضوعية", search: "ابحث باسم المكان أو المعلم", count: "لقطة موثقة", zoom: "تكبير الصورة", atlas: "افتح في الأطلس", visit: "ملف الوجهة", archive: "أرشيف الصور المرفق لمنصة Visit Libya", reset: "مسح الفلاتر", share: "نسخ رابط اللقطة", copied: "تم النسخ", empty: "لا توجد لقطات مطابقة للفلاتر الحالية." },
  en: { eyebrow: "Center archive", title: "Libya, preserved in the image.", copy: "A field gallery from the Tourism Information and Documentation Center; every image is linked to its place, source, and landmark.", all: "All photographs", filter: "Filters", city: "City or site", type: "Destination type", season: "Visit season", albums: "Themed albums", search: "Search a place or landmark", count: "documented photographs", zoom: "Enlarge image", atlas: "Open in Atlas", visit: "Destination file", archive: "Visit Libya supplied image archive", reset: "Clear filters", share: "Copy image link", copied: "Copied", empty: "No photographs match the current filters." },
  fr: { eyebrow: "Archives du Centre", title: "La Libye, préservée par l’image.", copy: "Galerie de terrain du Centre d’information et de documentation touristique.", all: "Toutes les images", filter: "Filtres", city: "Ville ou site", type: "Type de destination", season: "Saison de visite", albums: "Albums thématiques", search: "Rechercher un lieu", count: "images documentées", zoom: "Agrandir", atlas: "Ouvrir dans l’Atlas", visit: "Fiche destination", archive: "Archives photo Visit Libya", reset: "Effacer les filtres", share: "Copier le lien", copied: "Copié", empty: "Aucune image ne correspond aux filtres." },
  it: { eyebrow: "Archivio del Centro", title: "La Libia, custodita nell’immagine.", copy: "Galleria sul campo del Centro di informazione e documentazione turistica.", all: "Tutte le immagini", filter: "Filtri", city: "Città o sito", type: "Tipo di destinazione", season: "Stagione di visita", albums: "Album tematici", search: "Cerca un luogo", count: "immagini documentate", zoom: "Ingrandisci", atlas: "Apri nell’Atlante", visit: "Scheda destinazione", archive: "Archivio fotografico Visit Libya", reset: "Cancella filtri", share: "Copia collegamento", copied: "Copiato", empty: "Nessuna immagine corrisponde ai filtri." },
  de: { eyebrow: "Zentrumsarchiv", title: "Libyen, im Bild bewahrt.", copy: "Feldgalerie des Tourismus-Informations- und Dokumentationszentrums.", all: "Alle Bilder", filter: "Filter", city: "Stadt oder Ort", type: "Reisezieltyp", season: "Reisesaison", albums: "Themenalben", search: "Ort suchen", count: "dokumentierte Bilder", zoom: "Vergrößern", atlas: "Im Atlas öffnen", visit: "Zielprofil", archive: "Visit Libya Bildarchiv", reset: "Filter löschen", share: "Bildlink kopieren", copied: "Kopiert", empty: "Keine Bilder entsprechen den Filtern." },
  es: { eyebrow: "Archivo del Centro", title: "Libia, preservada en la imagen.", copy: "Galería de campo del Centro de Información y Documentación Turística.", all: "Todas las imágenes", filter: "Filtros", city: "Ciudad o sitio", type: "Tipo de destino", season: "Temporada de visita", albums: "Álbumes temáticos", search: "Buscar lugar", count: "imágenes documentadas", zoom: "Ampliar", atlas: "Abrir en el Atlas", visit: "Ficha del destino", archive: "Archivo fotográfico Visit Libya", reset: "Limpiar filtros", share: "Copiar enlace", copied: "Copiado", empty: "No hay imágenes que coincidan con los filtros." },
  zh: { eyebrow: "中心档案", title: "以影像保存的利比亚。", copy: "旅游信息与文献中心的实地图片库。", all: "全部图片", filter: "筛选", city: "城市或遗址", type: "目的地类型", season: "游览季节", albums: "主题相册", search: "搜索地点", count: "已记录图片", zoom: "放大图片", atlas: "在地图集中打开", visit: "目的地档案", archive: "Visit Libya 图片档案", reset: "清除筛选", share: "复制图片链接", copied: "已复制", empty: "没有符合当前筛选条件的图片。" },
} as const;
...
export default function Gallery() {
  ...
  const visiblePhotos = useMemo(() => photos.filter((photo) => {
    ...
    return matchingCategory && matchingDestination && matchingSeason && matchingSearch;
  }), [category, destinationId, photos, query, season]);
  ...
  const resetFilters = () => { setCategory("all"); setDestinationId("all"); setSeason("all"); setAlbum("all"); setQuery(""); };
  const hasFilters = category !== "all" || destinationId !== "all" || season !== "all" || album !== "all" || Boolean(query);
